      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">📧 Email: your@email.com</p>
            <p className="text-gray-300 mb-2">📍 Location: Israel</p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} Виталий. All rights reserved. Built with Next.js & Django.
          </p>
        </div>
      </div>
    </footer>
